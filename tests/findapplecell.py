...
def get_center_point(start, end):
    cx = (start[0] + end[0]) / 2
    cy = (start[1] + end[1]) / 2
...
def main():
    ...
    apple = get_target_rect(game, 'img/apple.jpg')
    draw_rectangle(game, apple[0], apple[1], (255, 0, 0))

    ac = get_apple_cell(apple[0], apple[1], game_cells, 10)
    draw_rectangle(game, [int(ac[0][0]), int(ac[0][1])],  [int(ac[1][0]), int(ac[1][1])], (0, 0, 255))
